//original file is rtttl_player.cpp but adapted by Tobias van den Hoogen so that a cpp file with the correct play calls will be generated 
#ifndef _MELODY_HPP
#define _MELODY_HPP
#include "hwlib.hpp"
...
public:
   ...
   void char_to_note(const char *s){
         ...
         switch(state ){
            ...
            case 10:   
               if( ( c == ',' ) || ( c == '\0') ){
                  ...
                  melodyfile << "p.play( note{" << frequency / 1000  << "," << note_duration << "} );\n\t\t";
